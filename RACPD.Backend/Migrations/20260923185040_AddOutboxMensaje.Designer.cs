...
namespace RACPD.Backend.Migrations
{
    ...
    [Migration("20260923185040_AddOutboxMensaje")]
    partial class AddOutboxMensaje
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RACPD.Backend.Domain.Entities.OutboxMensaje", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<bool>("Fallo")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("Procesado", "Fecha")
                        .HasDatabaseName("IX_OutboxMensajes_Pendientes_FIFO");

                    b.ToTable("OutboxMensajes");
                });
