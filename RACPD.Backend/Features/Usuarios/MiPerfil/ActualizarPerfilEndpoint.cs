...
public class ActualizarPerfilValidator : Validator<ActualizarPerfilRequest>
{
...
public class ActualizarPerfilEndpoint : Endpoint<ActualizarPerfilRequest, MiPerfilResponse>
{
    private readonly AppDbContext _dbContext;

    public ActualizarPerfilEndpoint(AppDbContext dbContext)
    {
    ...
    public override async Task HandleAsync(ActualizarPerfilRequest req, CancellationToken ct)
    {
